...
export class QuestionPage {
  ...
  checkFollowStatus() {
    this.dataService.followStatus(4, this.selected_question_id).subscribe(
      data => {
        this.followed = true;
  ...
  showHideCommentBar() {
    ...
    if (this.viewAnswerBar) this.viewAnswerBar = !this.viewAnswerBar;
  }
  ...
  showHideAnswerBar() {
    ...
    if (this.viewCommentBar) this.viewCommentBar = !this.viewCommentBar;
  }
